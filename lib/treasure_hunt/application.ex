defmodule TreasureHunt.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {TreasureHunt.GameManager, [TreasureHunt.RockPaperScissorsManager, TreasureHunt.GuessTheNumberManager, TreasureHunt.DiceManager]}#, TreasureHunt.DiceManager, TreasureHunt.HangmanManager, TreasureHunt.RockPaperScissorsManager]}
    ]
