defmodule TreasureHunt.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {TreasureHunt.GameManager, [TreasureHunt.GuessTheNumberManager]}#, TreasureHunt.DiceManager, TreasureHunt.HangmanManager, TreasureHunt.RockPaperScissorsManager]}
    ]
